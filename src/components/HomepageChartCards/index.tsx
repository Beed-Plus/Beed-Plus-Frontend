...
export default function HomepageChartCards(props: HPCCInterface){
    return(
        <Link to={props.link} className="md:col-span-2">
            <div className={`relative h-[232px] lg:h-[333px] rounded-[16px] my-4`} style={{backgroundColor: props.color}}>
                <div className="p-4 h-full bg-[url(/scribble-bg.png)] bg-bottom">
                    <div className="relative h-full">
                        ...
                        <p className={`absolute bottom-0 right-0 lg:bottom-0 lg:right-0 text-[36px] xl:text-[72px] font-bold ${props.textColor == "black" ? "text-black" : "text-white"} text-right w-[65%]`}>{props.text}</p>
                    </div>
